 ...
 *
 * Takes in Letter as input, the the value to be converted, does the conversion and outputs result(s)
...
int main() {
  ...
  while(flag) {
    ...
    default:
    cout << "Error!!!\n";               // Outputs Error if wrong value or letter is given as input
    }
